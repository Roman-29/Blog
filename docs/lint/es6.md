...
> 源于 github上[airbnb-es6](https://github.com/airbnb/javascript)编码规范

## Types
  <a name="references--prefer-const"></a><a name="2.1"></a>
  - [1.1](#references--prefer-const) **Primitives**: When you access a primitive type you work directly on its value.
